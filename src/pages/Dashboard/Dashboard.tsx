  ...
  return (
    <div className="space-y-8">
      <div className="card">
        ...
        <div className="bg-zinc-800/60 rounded-xl p-6 border border-zinc-700/50">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-white">{t('dashboard.raidSchedule')}</h3>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="card group hover:bg-zinc-800/70 transition-all duration-200">
