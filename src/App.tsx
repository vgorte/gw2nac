  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="card">
          ...
          <div className="bg-gradient-to-r from-blue-900/30 to-cyan-900/30 rounded-lg p-6 border border-blue-500/30">
            <div className="flex items-center gap-6 mb-6">
              <div className="relative">
                <img 
                  src="/src/assets/images/classes/guardian.jpg" 
              ...
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  <span className="px-2 py-1 bg-blue-800/50 text-blue-200 rounded text-sm">{t('builds.classes.guardian.roles.support')}</span>
                  <span className="px-2 py-1 bg-blue-800/50 text-blue-200 rounded text-sm">{t('builds.classes.guardian.roles.damage')}</span>
                  <span className="px-2 py-1 bg-blue-800/50 text-blue-200 rounded text-sm">{t('builds.classes.guardian.roles.heavyArmor')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {guardianBuilds.map((build) => (
                <div key={build.id} className="bg-gray-800/50 rounded-lg p-4 border border-gray-700/50 hover:border-blue-500/50 transition-colors cursor-pointer">
        ...
        <div className="mb-8">
          <div className="bg-gradient-to-r from-orange-900/30 to-yellow-900/30 rounded-lg p-6 border border-orange-500/30">
            <div className="flex items-center gap-6 mb-6">
              <div className="relative">
                <img 
                  src="/src/assets/images/classes/warrior.jpg" 
                  ...
                  style={{ objectPosition: 'center 20%' }}
                />
                <div className="absolute inset-0 bg-gradient-to-t from-orange-900/40 to-transparent rounded-xl"></div>
              </div>
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  <span className="px-2 py-1 bg-orange-800/50 text-orange-200 rounded text-sm">{t('builds.classes.warrior.roles.meleeDps')}</span>
                  <span className="px-2 py-1 bg-orange-800/50 text-orange-200 rounded text-sm">{t('builds.classes.warrior.roles.frontline')}</span>
                  <span className="px-2 py-1 bg-orange-800/50 text-orange-200 rounded text-sm">{t('builds.classes.warrior.roles.heavyArmor')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {warriorBuilds.map((build) => (
                <div key={build.id} className="bg-gray-800/50 rounded-lg p-4 border border-gray-700/50 hover:border-orange-500/50 transition-colors cursor-pointer">
                  <div className="flex items-start justify-between mb-3">
        ...
        <div className="mb-8">
          <div className="bg-gradient-to-r from-green-900/30 to-emerald-900/30 rounded-lg p-6 border border-green-500/30">
            <div className="flex items-center gap-6 mb-6">
              <div className="relative">
                <img 
                  src="/src/assets/images/classes/necromancer.jpg" 
              ...
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  <span className="px-2 py-1 bg-green-800/50 text-green-200 rounded text-sm">{t('builds.classes.necromancer.roles.conditions')}</span>
                  <span className="px-2 py-1 bg-green-800/50 text-green-200 rounded text-sm">{t('builds.classes.necromancer.roles.support')}</span>
                  <span className="px-2 py-1 bg-green-800/50 text-green-200 rounded text-sm">{t('builds.classes.necromancer.roles.lightArmor')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {necromancerBuilds.map((build) => (
                <div key={build.id} className="bg-gray-800/50 rounded-lg p-4 border border-gray-700/50 hover:border-green-500/50 transition-colors cursor-pointer">
                  <div className="flex items-start justify-between mb-3">
        ...
        <div className="mb-8">
          <div className="bg-gradient-to-r from-red-900/30 to-orange-900/30 rounded-lg p-6 border border-red-500/30">
            <div className="flex items-center gap-6 mb-6">
              <div className="relative">
                <img 
                  src="/src/assets/images/classes/elementalist.jpg" 
              ...
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  <span className="px-2 py-1 bg-red-800/50 text-red-200 rounded text-sm">{t('builds.classes.elementalist.roles.elements')}</span>
                  <span className="px-2 py-1 bg-red-800/50 text-red-200 rounded text-sm">{t('builds.classes.elementalist.roles.support')}</span>
                  <span className="px-2 py-1 bg-red-800/50 text-red-200 rounded text-sm">{t('builds.classes.elementalist.roles.lightArmor')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {elementalistBuilds.map((build) => (
                <div key={build.id} className="bg-gray-800/50 rounded-lg p-4 border border-gray-700/50 hover:border-red-500/50 transition-colors cursor-pointer">
                  <div className="flex items-start justify-between mb-3">
        ...
        <div className="mb-8">
          <div className="bg-gradient-to-r from-yellow-900/30 to-amber-900/30 rounded-lg p-6 border border-yellow-500/30">
            <div className="flex items-center gap-6 mb-6">
              <div className="relative">
                <img 
                  src="/src/assets/images/classes/engineer.jpg" 
                  ...
                  style={{ objectPosition: 'center 20%' }}
                />
                <div className="absolute inset-0 bg-gradient-to-t from-yellow-900/40 to-transparent rounded-xl"></div>
              </div>
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  <span className="px-2 py-1 bg-yellow-800/50 text-yellow-200 rounded text-sm">{t('builds.classes.engineer.roles.technology')}</span>
                  <span className="px-2 py-1 bg-yellow-800/50 text-yellow-200 rounded text-sm">{t('builds.classes.engineer.roles.support')}</span>
                  <span className="px-2 py-1 bg-yellow-800/50 text-yellow-200 rounded text-sm">{t('builds.classes.engineer.roles.mediumArmor')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {engineerBuilds.map((build) => (
                <div key={build.id} className="bg-gray-800/50 rounded-lg p-4 border border-gray-700/50 hover:border-yellow-500/50 transition-colors cursor-pointer">
                  <div className="flex items-start justify-between mb-3">
        ...
        <div className="mb-8">
          <div className="bg-gradient-to-r from-purple-900/30 to-indigo-900/30 rounded-lg p-6 border border-purple-500/30">
            <div className="flex items-center gap-6 mb-6">
              <div className="relative">
                <img 
                  src="/src/assets/images/classes/revenant.jpg" 
                  ...
                  style={{ objectPosition: 'center 20%' }}
                />
                <div className="absolute inset-0 bg-gradient-to-t from-purple-900/40 to-transparent rounded-xl"></div>
              </div>
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  <span className="px-2 py-1 bg-purple-800/50 text-purple-200 rounded text-sm">{t('builds.classes.revenant.roles.legends')}</span>
                  <span className="px-2 py-1 bg-purple-800/50 text-purple-200 rounded text-sm">{t('builds.classes.revenant.roles.energy')}</span>
                  <span className="px-2 py-1 bg-purple-800/50 text-purple-200 rounded text-sm">{t('builds.classes.revenant.roles.heavyArmor')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {revenantBuilds.map((build) => (
                <div key={build.id} className="bg-gray-800/50 rounded-lg p-4 border border-gray-700/50 hover:border-purple-500/50 transition-colors cursor-pointer">
                  <div className="flex items-start justify-between mb-3">
        ...
        {/* Thief Class Section */}
        <div className="mb-8">
          <div className="bg-gradient-to-r from-gray-900/30 to-slate-900/30 rounded-lg p-6 border border-gray-500/30">
            <div className="flex items-center gap-6 mb-6">
              <div className="relative">
                <img 
                  src="/src/assets/images/classes/thief.jpg" 
              ...
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  <span className="px-2 py-1 bg-gray-800/50 text-gray-200 rounded text-sm">{t('builds.classes.thief.roles.stealth')}</span>
                  <span className="px-2 py-1 bg-gray-800/50 text-gray-200 rounded text-sm">{t('builds.classes.thief.roles.mobility')}</span>
                  <span className="px-2 py-1 bg-gray-800/50 text-gray-200 rounded text-sm">{t('builds.classes.thief.roles.mediumArmor')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {thiefBuilds.map((build) => (
                <div key={build.id} className="bg-gray-800/50 rounded-lg p-4 border border-gray-700/50 hover:border-gray-500/50 transition-colors cursor-pointer">
                  <div className="flex items-start justify-between mb-3">
        ...
        <div className="mb-8">
          <div className="bg-gradient-to-r from-pink-900/30 to-purple-900/30 rounded-lg p-6 border border-pink-500/30">
            <div className="flex items-center gap-6 mb-6">
              <div className="relative">
                <img 
                  src="/src/assets/images/classes/mesmer.jpg" 
                  ...
                  style={{ objectPosition: 'center 20%' }}
                />
                <div className="absolute inset-0 bg-gradient-to-t from-pink-900/40 to-transparent rounded-xl"></div>
              </div>
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  <span className="px-2 py-1 bg-pink-800/50 text-pink-200 rounded text-sm">{t('builds.classes.mesmer.roles.illusions')}</span>
                  <span className="px-2 py-1 bg-pink-800/50 text-pink-200 rounded text-sm">{t('builds.classes.mesmer.roles.utility')}</span>
                  <span className="px-2 py-1 bg-pink-800/50 text-pink-200 rounded text-sm">{t('builds.classes.mesmer.roles.lightArmor')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {mesmerBuilds.map((build) => (
                <div key={build.id} className="bg-gray-800/50 rounded-lg p-4 border border-gray-700/50 hover:border-pink-500/50 transition-colors cursor-pointer">
                  <div className="flex items-start justify-between mb-3">
        ...
        <div className="mb-8">
          <div className="bg-gradient-to-r from-emerald-900/30 to-teal-900/30 rounded-lg p-6 border border-emerald-500/30">
            <div className="flex items-center gap-6 mb-6">
              <div className="relative">
                <img 
                  src="/src/assets/images/classes/ranger.jpg" 
                  ...
                  style={{ objectPosition: 'center 20%' }}
                />
                <div className="absolute inset-0 bg-gradient-to-t from-emerald-900/40 to-transparent rounded-xl"></div>
              </div>
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  <span className="px-2 py-1 bg-emerald-800/50 text-emerald-200 rounded text-sm">{t('builds.classes.ranger.roles.nature')}</span>
                  <span className="px-2 py-1 bg-emerald-800/50 text-emerald-200 rounded text-sm">{t('builds.classes.ranger.roles.pets')}</span>
                  <span className="px-2 py-1 bg-emerald-800/50 text-emerald-200 rounded text-sm">{t('builds.classes.ranger.roles.mediumArmor')}</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {rangerBuilds.map((build) => (
                <div key={build.id} className="bg-gray-800/50 rounded-lg p-4 border border-gray-700/50 hover:border-emerald-500/50 transition-colors cursor-pointer">
                  <div className="flex items-start justify-between mb-3">
